...
describe("Function d tests", () => {
    ...
    // Test case 3: Check if $element.trigger is called with 'hidden.bs.bs'
    test("$element.trigger is called with 'hidden.bs.bs'", () => {
        bootstrap.d();
        expect(e.$element.trigger).toHaveBeenCalledWith("hidden.bs.bs");
    });
