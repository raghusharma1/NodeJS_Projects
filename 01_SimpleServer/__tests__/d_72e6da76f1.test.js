...
describe('bootstrap.min.js tests', () => {
  ...
  test('should call f.detach and e.$element.removeAttr and e.$element.trigger if hoverState is not "in"', () => {
    e.hoverState = 'out';
    bootstrap.d();
  ...
  test('should not call f.detach and e.$element.removeAttr and e.$element.trigger if hoverState is "in"', () => {
    bootstrap.d();
