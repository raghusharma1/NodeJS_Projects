...
describe('d function', () => {
  ...
  test('should call f.detach, removeAttr, trigger, and b when hoverState is not "in"', () => {
    d();
  ...
  test('should not call f.detach, removeAttr, trigger, and b when hoverState is "in"', () => {
    e.hoverState = 'in';
