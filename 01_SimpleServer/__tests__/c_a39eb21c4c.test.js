...
describe('c function in bootstrap.min.js', () => {
  ...
  // Test Case 3: Check if c function calls the function in data when string is passed as parameter
  test('should call the function in data when string is passed as parameter', () => {
    const testFunc = jest.fn();
    mockData['bs.scrollspy'] = { test: testFunc };
    bootstrap.c('test');
